      ...
      case 8:
        return (
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-sky-950 text-white py-3 rounded-lg hover:bg-blue-600 transition-all duration-300 ease-in-out"
            >
              Sign Up
            </button>
          </form>
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-8 bg-white/90 rounded-xl shadow-sm">
      ...
      {currentStep < 8 && (
        <button
          onClick={nextStep}
          className="w-full mt-6 bg-blue-950 text-white py-3 rounded-lg hover:bg-blue-700 transition-all duration-300 ease-in-out"
        >
          Next
        </button>
      )}
        ...
        {[1, 2, 3, 4, 5, 6, 7, 8].map((step) => (
          <div
            ...
            className={`w-2 h-2 rounded-full ${
              currentStep === step ? 'bg-sky-950' : 'bg-slate-200'
            }`}
          />
        ))}
      </div>
